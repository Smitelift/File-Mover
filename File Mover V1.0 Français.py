...
src_dir_label = tk.Label(text="Répertoire source:")
src_dir_entry = tk.Entry()
dest_dir_label = tk.Label(text="Répertoire de destination:")
dest_dir_entry = tk.Entry()
file_ext_label = tk.Label(text="Extension de fichier:")
file_ext_entry = tk.Entry()

# Créez les boutons de commande "Déplacer" et "Copier"
move_button = tk.Button(text="Déplacer", command=lambda: move_files(src_dir_entry.get(), dest_dir_entry.get(), file_ext_entry.get()))
copy_button = tk.Button(text="Copier", command=lambda: copy_files(src_dir_entry.get(), dest_dir_entry.get(), file_ext_entry.get()))
...
def move_files(src_dir, dest_dir, file_ext):
  ...
  messagebox.showinfo("Déplacement terminé", "Le déplacement des fichiers a été terminé avec succès.")
...
def copy_files(src_dir, dest_dir, file_ext):
  ...
  messagebox.showinfo("Copy terminée", "La copie des fichiers a été terminée avec succès.")
